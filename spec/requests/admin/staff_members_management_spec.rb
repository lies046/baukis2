...
describe "管理者による職員管理" do
  ...
  describe "更新" do
    ...
    example "hashed_passwordの値は書き換え不可" do
      ...
      expect{ patch admin_staff_member_url(staff_member),params:{staff_member: params_hash}}.not_to change{staff_member.hashed_password.to_s}
    end
  end
end